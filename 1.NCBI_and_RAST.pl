...
#		`wget http://www.ncbi.nlm.nih.gov/Traces/wgs/?download=$ID.1.fsa_nt.gz`;
		# https://sra-download.ncbi.nlm.nih.gov/traces/wgs03/wgs_aux/FN/CO/FNCO01/FNCO01.1.gbff.gz
...
#		`wget ftp://ftp.ncbi.nlm.nih.gov/sra/wgs_aux/$first/$second/$ID/$ID.1.fsa_nt.gz`;
		`wget https://sra-download.ncbi.nlm.nih.gov/traces/wgs03/wgs_aux/$first/$second/$ID/$ID.1.fsa_nt.gz`;
		print" https://sra-download.ncbi.nlm.nih.gov/traces/wgs03/wgs_aux/$first/$second/$ID/$ID.1.fsa_nt.gz\n";
